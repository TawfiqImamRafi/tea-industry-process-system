...
@section('content')
    ...
    <div class="box">
        <div class="box-header with-action">
            <h5 class="box-title">Update New Blog</h5>
        ...
        <div class="box-body">
                ...
                <div class="col-md-9">
                    <select class="form-select form-control bg-gray-50" id="" name="blog_category">
                        ...
                        @foreach($categories as $category)
                            <option value={{ $category->id }} {{ $category->id == $blog->blog_category ? 'selected':'' }}>{{ $category->name }}</option>
                        @endforeach
                    </select>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input type="text" name="title" id="title" placeholder="Enter title" class="form-control" value="{{$blog->title}}">
                    <span class="text-danger">{{ $errors->first('title') }}</span>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input type="text" name="slug" id="title" placeholder="Enter slug" class="form-control bg-gray-50" value="{{$blog->slug}}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <textarea type="text" name="description" id="" placeholder="Enter description" class="form-control description_summernote">{{$blog->description}}</textarea>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input type="text" name="meta_page_id" id="" placeholder="Enter meta page id" class="form-control bg-gray-50" value="{{$blog->meta_page_id}}">
