            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="company_name" value={{ $price->company_name }} id="title"
                                placeholder="Enter company name" class="form-control bg-gray-50">
                            ...
                            <select class="form-select form-control bg-gray-50" id="" name="category_id">
                                ...
                                @foreach ($categories as $category)
                                    <option value={{ $category->id }}
                                        {{ $category->id == $price->category_id ? 'selected' : '' }}>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="date" name="date" id="title" placeholder="Enter tea price"
                                class="form-control bg-gray-50" value={{ $price->date }} readonly>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="number" name="tea_price" id="title" placeholder="Enter tea price"
                                class="form-control bg-gray-50" value={{ $price->tea_price }}>
                            <span class="text-danger">{{ $errors->first('tea_price') }}</span>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="number" name="amount" value={{ $price->amount }} id="title"
                                placeholder="Enter weight" class="form-control bg-gray-50">
