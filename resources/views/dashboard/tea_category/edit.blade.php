...
@section('content')
    ...
    <div class="row">
        ...
        <div class="box-header with-action">
            <h5 class="box-title">Update New Tea Category</h5>
        ...
        <div class="box-body">
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input type="text" name="name" id="name" placeholder="Enter name" class="form-control" value="{{$category->name}}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <textarea type="text" name="description" id="title" placeholder="Enter description" class="form-control bg-gray-50" >{{$category->description}}</textarea>
